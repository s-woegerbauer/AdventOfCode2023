...
namespace AdventOfCode2023
{
    internal class DayThree
    {
        ...
        {
            string[] testInput = InputOutputHelper.GetInput(true, "03");
            PartOne(true, testInput);

            string[] input = InputOutputHelper.GetInput(false, "03");
            PartOne(false, input);
        ...
        public static (List<Num> extractedNumbers, List<Symbol> extractedSymbols) ExtractNumbersAndSymbols(string rowData, int row)
        {
            List<Num> numbers = new List<Num>();
            List<Symbol> symbols = new List<Symbol>();
            List<int> digits = new List<int>();
            Num currentNumber = new Num();
